...
public class EmailConstant {
    ...
    public static final String USERNAME = "kouraichiahmed2@gmail.com";
    public static final String PASSWORD = "rtmkfuzgrzwmwyou";
    public static final String FROM_EMAIL = "kouraichiahmed2@gmail.com";
